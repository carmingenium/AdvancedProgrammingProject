        ...
        Ans1.setOnCheckedChangeListener(
                new RadioGroup
                    ...
                    public void onCheckedChanged(RadioGroup group,
                        ...
                        if(ans2.isChecked())
                        {
                            Toast.makeText(DayCountingPlay.this, getString(R.string.Warn_Success), Toast.LENGTH_SHORT).show();
                        }
                        else
                        {
                            Toast.makeText(DayCountingPlay.this, getString(R.string.Warn_Failed), Toast.LENGTH_LONG).show();
                        }
                    }
                });

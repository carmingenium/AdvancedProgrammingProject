...
public class NumberCountingReversePlay extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_number_counting_reverse_play);
            ...
            public void onFocusChange(View v, boolean b) {
                ...
                if(!val1.isEmpty()) {
                    try {
                        ...
                        if (ans1 == 9) {
                            Toast.makeText(NumberCountingReversePlay.this, getString(R.string.Warn_Success), Toast.LENGTH_SHORT).show();
                        } else {
                            Toast.makeText(NumberCountingReversePlay.this, getString(R.string.Warn_Failed), Toast.LENGTH_SHORT).show();
                        }
                    }
                    catch (NumberFormatException excl) {
                        Toast.makeText(NumberCountingReversePlay.this, getString(R.string.Warn_TextOnly), Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
